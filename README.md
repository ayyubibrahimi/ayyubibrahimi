...
| --- | --- | --- | --- |
| **Louisiana Law Enforcement Accountability Database (LLEAD)** | Co-developing [LLEAD.co](https://www.llead.co) | Python, Django | [View Repo](https://github.com/ipno-llead/processing) |
| **Sawt** | Co-developing Sawt for New Orleanians to engage with City Council meetings | React, Node.js | [View Repo](https://github.com/eye-on-surveillance/sawt) |
...
| **EOS** | Lead research for a coalition on law enforcement surveillance in New Orleans | Python, Data Analytics | [View Repo](https://github.com/ayyubibrahimi/eos) |
